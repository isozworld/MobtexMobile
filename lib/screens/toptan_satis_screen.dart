...
class ToptanSatisScreen extends StatefulWidget {
  const ToptanSatisScreen({super.key});

  @override
  State<ToptanSatisScreen> createState() => _ToptanSatisScreenState();
}

class _ToptanSatisScreenState extends State<ToptanSatisScreen> {
...
// Plasiyer arama metodu
  ...
  void _navigateToBarcodeScan() {
    ...
    // Seçimleri kaydet
    _dbHelper.saveToptanSatisSelections(
